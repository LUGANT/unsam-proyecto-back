...
) : InitializingBean
{
    override fun afterPropertiesSet() {
        ...
        val usuarioC = Usuario(nombre = "Lucas", apellido = "Antenni", username = "lugant", password = "1234", imgUrl = "https://resizer.glanacion.com/resizer/v2/enzo-fernandez-quedo-involucrado-en-un-acto-de-LQE3YKV43JF5XETTJ3A3V5LTL4.JPG?auth=12a4bf5013ba36bf8d108403e4a4f0e5f293f235467d5fd51605dbc3ac0f7f11&width=420&height=280&quality=70&smart=true")
        val usuarioD = Usuario(nombre = "Rodrigo", apellido = "Tartaglia", username = "rodri", password = "1234", imgUrl = "https://static.wikia.nocookie.net/naruto/images/a/a2/Naruto_Uzumaki_Parte_II_Anime.png/revision/latest?cb=20161013194453&path-prefix=es")
        val usuarioE = Usuario(nombre = "Nicolas", apellido = "Stebner", username = "nico", password = "1234", imgUrl = "https://www.ecured.cu/images/a/a2/JON.jpg")
        val usuarioF = Usuario(nombre = "Gonzalo", apellido = "Mendez", username = "gonm", password = "1234", imgUrl = "https://media.vandal.net/i/1200x900/9-2022/202291917113545_1.jpg")
